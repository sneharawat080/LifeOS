...
import { ResumeAnalysis } from "@/components/career/ResumeAnalysis";
import { CareerRoadmap } from "@/components/career/CareerRoadmap";
import { useProfile, useCareerProfile } from "@/hooks/useProfile";
    ...
    <div className="space-y-8">
      ...
      {!hasData ? (
        ...
        <>
          ...
          {/* Resume Analysis */}
          <ResumeAnalysis skills={skills} storedAnalysis={storedAnalysis} resumeUrl={careerProfile?.resume_url} />

          {/* Career Roadmap */}
          <CareerRoadmap profile={profile} careerProfile={careerProfile} />
